...
<head>
    ...
    <title>Add Notice - RHABHIT Admin</title>
...
<form action="cores/add_notice_core.php" method="POST" enctype="multipart/form-data">
    <div class="container">
        <div class="row">
            ...
            <div class="d-grid gap-2 col-12 mx-auto">
                <button type="submit" name="add-notice-btn" class="btn btn-primary" type="button">Add Notice</button>
            </div>
        </div>
    </div>
</form>
