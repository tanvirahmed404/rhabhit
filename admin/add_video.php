...
?>
<h1 class="ms-2 mb-3">Add Video</h1>

<form action="cores/add_video_core.php" method="POST">
    <div class="container">
        <div class="row">
            ...
            <div class="d-grid gap-2 col-12 mx-auto">
                <button type="submit" name="add-video-btn" class="btn btn-primary" type="button">Add Video</button>
            </div>
        </div>
    </div>
</form>
