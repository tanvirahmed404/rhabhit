...
<h1 class="ms-2 mb-3"> All Notice</h1>
...
$showNotice="SELECT * FROM notices ORDER BY notice_id DESC LIMIT {$offset},{$limit}";
...
?>
        ...
        <tr>
            ...
            <td style="text-align:left"><?php echo $notice["uploaded_file"]; ?></td>
            <td><?php echo date('d-m-Y',strtotime($notice["date"])); ?></td>
            <td><a href="edit_notice.php?id=<?php echo $notice["notice_id"]; ?>"><i
                        class="fa-solid fa-pen-to-square"></i></a></td>
            <td><a onclick="return confirm('Are you Sure?');"
                    href="cores/delete_notice_core.php?id=<?php echo $notice["notice_id"]; ?>&file=<?php echo $notice["uploaded_file"]; ?>"><i
...
$showNotice1="SELECT * FROM notices";
...
?>
<li class=" page-item">
    <a class="page-link" href="./all_notices.php?page=<?php echo ($page_number-1); ?>">Previous</a>
    </li>
    <?php
}
?>
...
?>
    <li class=" page-item <?php echo $active; ?>"><a class="page-link"
            href="./all_notices.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
    </li>
...
?>
    <li class="page-item">
        <a class="page-link" href="./all_notices.php?page=<?php echo ($page_number+1); ?>">Next</a>
    </li>
    <?php
}
?>
