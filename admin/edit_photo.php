...
<head>
    ...
    <title>Edit Photo - RHABHIT Admin</title>
...
if($count>0){
    while($getData=mysqli_fetch_array($run)){
      $photo_id=$getData["photo_id"];
      $title=$getData["title"];
      $uploaded_file=$getData["img_name"];
    }
}

?>
<h1 class="ms-2 mb-3"> Edit Photo</h1>

<form action="cores/edit_photo_core.php" method="POST" enctype="multipart/form-data">
    <div class="container">
        <div class="row">
            ...
            <input type="hidden" name="old_photo" value="<?php echo $uploaded_file; ?>">


            <div class="d-grid gap-2 col-12 mx-auto">
                <button type="submit" name="edit-photo-btn" class="btn btn-primary" type="button">Edit Photo</button>
            </div>
        </div>
    </div>
</form>
