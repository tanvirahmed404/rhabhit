...
<head>
    ...
    <title>Edit Result - RHABHIT Admin</title>
...
if($count>0){
    while($getData=mysqli_fetch_array($run)){
      $id=$getData["id"];
      $title=$getData["title"];
      $uploaded_file=$getData["file_name"];
    }
}

?>
<h1 class="ms-2 mb-3"> Edit Result</h1>

<form action="cores/edit_result_core.php" method="POST" enctype="multipart/form-data">
    <div class="container">
        <div class="row">
            ...
            <div class="d-grid gap-2 col-12 mx-auto">
                <button type="submit" name="edit-result-btn" class="btn btn-primary" type="button">Edit Result</button>
            </div>
        </div>
    </div>
</form>
